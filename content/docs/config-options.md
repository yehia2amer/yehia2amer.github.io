...
description = "Few config options provides by Software & Beyond theme."
date = 2020-08-30
...
Software & Beyond theme provides some config option like option to add favicon to your site, add avatar for profile, setup social links for the profile etc
...
**Software & Beyond** support google analytics out of the box. You can configure favicon in `[extra.analytics]` of `config.toml` file. 
...
**Software & Beyond** support hyvor commenting out of the box. You can configure favicon in `[extra.commenting]` of `config.toml` file. 
...
**Software & Beyond** support mapbox out of the box to add maps in your posts. You can configure favicon in `[extra.mapbox]` of `config.toml` file. 
